# Contributing to the Puppy ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.puppyswap.finance/code/contributing) first.
...
Translation in crowdin: `%asset% Earned` [link](https://crowdin.com/translate/puppyswap/8/en-de#330)
